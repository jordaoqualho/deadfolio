...
export function aiConfigured() {
  return (
    process.env.AI_ENABLED === "true" && Boolean(process.env.GEMINI_API_KEY)
  );
}
export async function extractProject(story: string) {
